...
class MenuCreateView(LoginRequiredMixin, UserPassesTestMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse_lazy("menu:menu_list", kwargs={"restaurant_id": self.kwargs["restaurant_id"]})
...
class MenuUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse_lazy("menu:menu_detail", kwargs={"pk": self.get_object().pk})
...
class MenuDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    ...
    def get_success_url(self):
        menu = self.get_object()
        return reverse_lazy("menu:menu_list", kwargs={"restaurant_id": menu.restaurant.pk})
