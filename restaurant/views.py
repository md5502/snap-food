...
from .forms import RestaurantCommentForm, RestaurantForm
from .models import (
    Restaurant,
    RestaurantComment,
...
class RestaurantCommentCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse("restaurant:detail_restaurant", kwargs={"pk": self.kwargs.get("pk")})
...
class RestaurantCommentUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse("restaurant:detail_restaurant", kwargs={"pk": self.object.restaurant.pk})
...
def restaurant_comment_like_view(request, comment_pk):
    ...
    if like_comment and user == like_comment.user:
        ...
        return redirect("restaurant:detail_restaurant", pk=restaurant_pk)
...
def restaurant_comment_reply_view(request, parent_comment_pk):
    ...
    if request.method == "POST":
        ...
        if not text_replay:
            ...
            return redirect("restaurant:detail_restaurant", pk=parent_comment.restaurant.pk)
